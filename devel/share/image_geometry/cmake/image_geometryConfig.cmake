...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/lmk/getdata_ws/src/vision_opencv-noetic/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/lmk/getdata_ws/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/lmk/getdata_ws/install)
...
if(NOT "/home/lmk/getdata_ws/src/vision_opencv-noetic/image_geometry/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/lmk/getdata_ws/src/vision_opencv-noetic/image_geometry/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lmk/getdata_ws/src/vision_opencv-noetic/image_geometry/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_geometry_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_geometry;/usr/local/lib/libopencv_img_hash.so.4.5.5;/usr/local/lib/libopencv_world.so.4.5.5")
